	...
	public class NotUniqueException : System.Exception
	{
		...
		#region Properties
			public override string Message
				=> $"Field {strUniqueFieldName} is required to be unique.  But it isn't.  The value {strValueInUse} is used already.  {
					(strDescriptiveFieldUse != null ? "  " + strDescriptiveFieldUse : "")}";
		#endregion
	}
}