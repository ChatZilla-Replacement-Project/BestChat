...
public class ChanAutoPerformPrefs : Platform.DataAndExt.Prefs.AbstractChildMgr, IAutoPerformOnEvtPrefs
{
	#region Constructors & Deconstructors
		public ChanAutoPerformPrefs(ChanPrefs mgrParent, NetAutoPerformPrefs inheritedSettings) :
			base(mgrParent, "Steps to take when joining this channel", PrefsRsrcs.strNetChanAutoPerformTitle, PrefsRsrcs
				.strNetChanAutoPerformDesc)
		{
			...
			System.Collections.Generic.List<ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>>
				listDefEnabledAliases = new(this.inheritedSettings.WhenJoiningChan.AllInheritanceOverrides.Count +
					inheritedSettings.WhenJoiningChan.AdditionalSteps.Count);
			listDefEnabledAliases.AddRange(inheritedSettings.WhenJoiningChan.AllInheritanceOverrides.Values
				.Select(istep
					=> new ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>(istep.inheritedItem, istep
						.Status, ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>
						.InheritedFromTypes.global, PrefsRsrcs.strOneStepText, inheritedSettings.mgrParent.OwnerNet)
			));
			listDefEnabledAliases.AddRange(inheritedSettings.WhenJoiningChan.AdditionalSteps.Select(istepCur
			...
			mapAllInheritanceOverrides = new(
				...
				(inherited,
						evth)
					=> inherited.inheritedItem.evtWhatToDoChanged += mapOverrideHandlers[evth] = (in GlobalAutoPerformOneStep _,
							in GlobalAutoPerformOneStep.CmdCall cmdcOld, in GlobalAutoPerformOneStep.CmdCall _)
						=> evth(cmdcOld, inherited),
				(inherited,
						evth)
					=>
						{
		...
		public ChanAutoPerformPrefs(ChanPrefs mgrParent, DTO.ChanAutoPerformDTO dto, NetAutoPerformPrefs inheritedSettings)
			: base(mgrParent, "Steps to take when joining this channel", PrefsRsrcs.strNetChanAutoPerformTitle, PrefsRsrcs
				.strNetChanAutoPerformDesc)
		{
			this.inheritedSettings = inheritedSettings;
			...
			listDefEnabledAliases.AddRange(inheritedSettings.WhenJoiningChan.AllInheritanceOverrides.Values
				.Select(istep
					=> new ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>(istep.inheritedItem, istep
						.Status, ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>.InheritedFromTypes
						.global, PrefsRsrcs.strOneStepText, inheritedSettings.mgrParent.OwnerNet)
				));
			listDefEnabledAliases.AddRange(inheritedSettings.WhenJoiningChan.AdditionalSteps.Select(istepCur
					=> new ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>(istepCur, true,
						ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>.InheritedFromTypes.network,
			...
			foreach(ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep> istepCur in
					listEnabledInheritedSteps)
				istepCur.evtDirtyChanged += (in NetInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep> _,
						in bool bNowDirty)
					=>
						{
							if(bNowDirty)
			...
			listEnabledInheritedSteps.AddRange(inheritedSettings.WhenJoiningChan.AdditionalSteps.Select(istepCur
				=> new ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>(istepCur, !dto
					.DisabledInheritedSteps?.Contains(istepCur.guid) ?? true,
					ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>.InheritedFromTypes.network,
					PrefsRsrcs.strAliasText, inheritedSettings.mgrParent.OwnerNet)));
			mapAllInheritanceOverrides = new(
				this,
				...
				(inherited,
						evth)
					=> inherited.inheritedItem.evtWhatToDoChanged += mapOverrideHandlers[evth] = (in GlobalAutoPerformOneStep _,
							in GlobalAutoPerformOneStep.CmdCall cmdcOldWhatToDo, in GlobalAutoPerformOneStep.CmdCall
							_)
						=> evth(cmdcOldWhatToDo, inherited),
				(inherited,
						evth)
					=>
						{
	...
	#region Members
		...
		private readonly System.Collections.Generic.Dictionary<System.Action<GlobalAutoPerformOneStep.CmdCall,
			ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>>, GlobalAutoPerformOneStep
	...
	#region Properties
		public Platform.DataAndExt.Prefs.MappedListItem<GlobalAutoPerformOneStep.CmdCall, ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep,
			IReadOnlyOneStep>> AllInheritanceOverrides
	...
	#region Methods
		...
		private GlobalAutoPerformOneStep.CmdCall KeyObtainer(ChanInheritedItemEnabledStatus<GlobalAutoPerformOneStep, IReadOnlyOneStep>
				istepCur)
