...
public class NetStalkWordsPrefs : Platform.DataAndExt.Prefs.AbstractChildMgr
{
			...
			.strNetStalkWordsDesc)
	{
		...
		System.Collections.Generic.IEnumerable<NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>> defInheritedEntries =
		...
		mapAllInheritanceOverridesByCtnts = new(
			...
			(inherited,
				...
				=> inherited.evtKeyOfInheritedItemChanged += mapOverrideHandlers[evth] = (in
						NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord> inherited, in string strOldCtnts, in string _)
		...
		addedStalkWords = new(
			...
			(swEntry,
					evth)
				=> swEntry.evtCtntsChanged += mapAddedStalkWordHandlers[evth] = (in GlobalStalkWordsOneStalkWord swEntry, in string strNewCtnts, in string _)
	...
	public NetStalkWordsPrefs(NetPrefsBase mgrParent, DTO.NetStalkWordsDTO dto,
		GlobalStalkWordsPrefs inheritedSettings) :
		base(mgrParent, "Stalk words", PrefsRsrcs.strNetStalkWordsTitle, PrefsRsrcs
			.strNetStalkWordsDesc)
	{
		this.mgrParent = mgrParent;
		...
		System.Collections.Generic.IEnumerable<NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>> defInheritedEntries =
			inheritedSettings.Entries.Values.Select(iswCur
				=> new NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>(iswCur));
		System.Collections.Generic.IEnumerable<NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>> enabledAltNicks = inheritedSettings
			.Entries.Values.Select(iswCur
				=> new NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>(iswCur, dto?.DisabledInheritedStalkWords?
	...
	private readonly Platform.DataAndExt.Prefs.MappedObjListItem<string,
		NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>> mapAllInheritanceOverridesByCtnts;

	private readonly System.Collections.Generic.Dictionary<System.Action<string,
		NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>>, NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>.DFieldChanged<string>> mapOverrideHandlers = [];

	private readonly Platform.DataAndExt.Prefs.MappedSortedListItem<string, GlobalStalkWordsOneStalkWord> addedStalkWords;

	private readonly System.Collections.Generic.Dictionary<System.Action<string, GlobalStalkWordsOneStalkWord>, GlobalStalkWordsOneStalkWord.DFieldChanged<string>> mapAddedStalkWordHandlers
		= [];
	#endregion

	#region Properties
	public Platform.DataAndExt.Prefs.MappedObjListItem<string, NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord>> AllInheritanceOverridesByCtnts
	...
	private static string KeyObtainer(NetInheritedItemEnabledStatus<GlobalStalkWordsOneStalkWord, IReadOnlyOneStalkWord> iswCur)
