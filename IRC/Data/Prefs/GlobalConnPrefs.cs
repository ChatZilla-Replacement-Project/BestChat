...
public class GlobalConnPrefs : Platform.DataAndExt.Prefs.AbstractChildMgr
{
	#region Constructors & Deconstructors
			...
			base(mgrParent,"Connection", PrefsRsrcs.strGlobalConnTitle, PrefsRsrcs.strGlobalConnDesc)
		{
			...
			rejoinAfterKick = new(this, "Rejoin After Kick", PrefsRsrcs.strGlobalConnRejoinAfterKickTitle,
				PrefsRsrcs.strGlobalConnRejoinAfterKickDesc, true);

			characterEncoding = new(this, "Character Encoding", PrefsRsrcs.strGlobalConnCharEncodingTitle,
				PrefsRsrcs.strGlobalConnCharEncodingDesc, "UTF-8");
			...
			maxAttempts = new(this, "Maximum Attempts to Reconnect", PrefsRsrcs.strGlobalConnMaxAttemptsTitle,
				PrefsRsrcs.strGlobalConnMaxAttemptsDesc, 1, iMinVal: 1);
		...
		internal GlobalConnPrefs(Platform.DataAndExt.Prefs.AbstractMgr mgrParent, GlobalConnDTO dto) :
			base(mgrParent, "Connection", PrefsRsrcs.strGlobalConnTitle, PrefsRsrcs.strGlobalConnDesc)
		{
			enableIndent = new(this, "Enable Ident", PrefsRsrcs.strGlobalConnEnableIdentTitle, PrefsRsrcs
			...
			rejoinAfterKick = new(this, "Rejoin After Kick", PrefsRsrcs.strGlobalConnRejoinAfterKickTitle,
				PrefsRsrcs.strGlobalConnRejoinAfterKickDesc, true, dto.IsRejoinAfterKickEnabled);

			characterEncoding = new(this, "Character Encoding", PrefsRsrcs.strGlobalConnCharEncodingTitle,
				PrefsRsrcs.strGlobalConnCharEncodingDesc, "UTF-8", dto.CharEncoding);

			unlimitedAttempts = new(this, "Unlimited Reconnection Attempts", PrefsRsrcs
				.strGlobalConnUnlimitedAttemptsTitle, PrefsRsrcs.strGlobalConnUnlimitedAttemptsDesc, true, dto
				.IsUnlimitedAttemptsOn);

			maxAttempts = new(this, "Maximum Attempts to Reconnect", PrefsRsrcs.strGlobalConnMaxAttemptsTitle,
				PrefsRsrcs.strGlobalConnMaxAttemptsDesc, 1, iMinVal: 1, iCurVal: dto.MaxAttempts);
	...
	#region Methods
		public virtual GlobalConnDTO ToDTO()
			=> new(
				enableIndent.CurVal,
